...
## 性能基准（2026-06-03, Round 77 — 无新方向，基准回归测试）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3626 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9937 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4272 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> ⚠️ 本轮 bench2/bench5 较 Round 76 各下降约 4%，bench4 持平。代码自 Round 76 以来零改动，归因为压测噪声。

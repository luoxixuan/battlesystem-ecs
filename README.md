...
## 性能基准（2026-06-04, Round 90 — 敌怪互相对抗 Enemy Infighting）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3671 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9848 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4076 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 -0.3%、bench4 -0.7%、bench5 +0.4% — 全部在 ±1% 噪声内。FactionInfightEnabled 懒门控确保 opt-in 0 怪物时零开销。

...
## 性能基准（2026-06-05, Round 121 — 方向一：运行时路径分支 Runtime Path Branching at Junction）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3177 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **8438 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **3695 FPS** |

...
## 性能基准（2026-06-03, Round 83 — 元素暴露 Elemental Exposure）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3675 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9853 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4152 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 +3.1%、bench4 +14.5%、bench5 +0.1% — 全部在噪声内或改善。bench4 接近 4300 阈值，仍低于预设门槛（持续观察）。

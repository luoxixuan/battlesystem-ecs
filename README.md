...
## 性能基准（2026-06-04, Round 93 — 关卡可破坏物 Destructible Obstacles）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3550 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **10161 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4018 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮新增方向5（关卡可破坏物 Destructible Obstacles）：木箱/油桶可被塔攻击打爆，油桶爆炸对 5 格内敌人造成 50% maxHP 伤害。bench2 10161（+0.3%）、bench4 4018（+5.9%）、bench5 3550（-1.5%）— 全部在噪声范围内。
>

...
## 性能基准（2026-06-03, Round 85 — 塔回收残值 Salvage Refund）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3732 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9724 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **3985 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 +2.7%、bench4 -5.1%、bench5 +0.3% — bench2/bench5 在噪声内，bench4 略降仍低于 4300 阈值。整体未突破预设门槛（持续观察）。

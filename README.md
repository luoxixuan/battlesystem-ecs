...
## 性能基准（2026-06-05, Round 117 — 方向一：每元素抗性 Per-Element Resistance）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3256 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **8694 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **3666 FPS** |

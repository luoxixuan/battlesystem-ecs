...
## 性能基准（2026-06-03, Round 85 — 暴击抗性 Crit Resistance）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3719 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9467 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4197 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 -3.9%、bench4 +1.1%、bench5 +1.2% — 全部在噪声内。bench4 接近 4300 阈值，仍低于预设门槛（持续观察）。

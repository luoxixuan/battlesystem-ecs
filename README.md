...
## 性能基准（2026-06-04, Round 89 — 路径地形成本 Path Tile Cost）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3657 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9876 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4104 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 +0.6%、bench4 -1.6%、bench5 +6.7% — 全部在 ±10% 噪声内。bench5 较 R87 显著回弹。

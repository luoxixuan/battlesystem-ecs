...
## 性能基准（2026-06-04, Round 87 — 塔射弹偏转 Projectile Deflection）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3428 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9822 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4171 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 -1.6%、bench4 -1.6%、bench5 -7.5% — 全部在 ±10% 噪声内。bench5 下降接近 10% 警告线（⚠️ 观察中）。

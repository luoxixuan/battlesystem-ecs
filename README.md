...
## 性能基准（2026-06-03, Round 84 — 自由游荡敌人 Free-Roam Enemies）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3702 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9954 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4134 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 +1.0%、bench4 -0.4%、bench5 +0.7% — 全部在噪声内。bench4 接近 4300 阈值，仍低于预设门槛（持续观察）。

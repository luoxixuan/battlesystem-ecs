...
## 性能基准（2026-06-03, Round 79 — 锁定目标塔 Target Lock-On Tower）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3771 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9795 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4127 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> ✅ 本轮 bench2 较 R78 +1.6%、bench4 -1.7%、bench5 +0.6%，全部在 ±5% 噪声内。

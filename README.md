...
## 性能基准（2026-06-03, Round 86 — 波次金币衰减 Decaying Wave Bounty）

| 指标 | 数值 |
|------|------|
| **mode 5**（完整一局） | **3708 FPS**，400 帧 |
| **mode 2**（合并热路径，10K 敌 × 500 帧） | **9985 FPS** |
| **mode 4**（真实系统链路，10K 敌 × 500 帧） | **4239 FPS** |
| mode 3 | 微基准测试（单系统操作级性能剖析） |

> 本轮 bench2 +2.7%、bench4 +6.4%、bench5 -0.6% — 全部在 ±10% 噪声内，整体未突破预设门槛（持续观察）。

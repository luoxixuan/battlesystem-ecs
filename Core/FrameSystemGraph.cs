...
namespace BattleSystemECS.Core
{
    internal static class FrameSystemGraph
    {
        ...
        private static void RegisterCombat(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveAction("combat.rally.consume",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.ResourceEvents,FrameResource.PlayerAttributes,FrameResource.TowerState},new[]{FrameResource.PlayerAttributes,FrameResource.TowerCombatCache},s.GraphConsumeRally);
        ...
        private static void RegisterSkillBuff(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveBinding(s,"skill-buff.rally.update",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.ResourceEvents,FrameResource.PlayerAttributes,FrameResource.TowerState},new[]{FrameResource.PlayerAttributes,FrameResource.TowerCombatCache});
        }

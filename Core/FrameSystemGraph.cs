...
namespace BattleSystemECS.Core
{
    internal static class FrameSystemGraph
    {
        ...
        private static void RegisterBuild(Registrar r, FrameScheduler s)
        {
            ...
            r.AddBuildAction("build.ability.commit",FrameTimeDomain.None,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.AbilityRequests,FrameResource.PhaseState,FrameResource.EntityLifecycle,FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.EnemyHealth,FrameResource.EnemyControl,FrameResource.TowerState,FrameResource.ActiveEffects},new[]{FrameResource.AbilityRequests,FrameResource.AbilitiesCommitted,FrameResource.DamageRequests,FrameResource.ResourceRequests,FrameResource.ActiveEffects,FrameResource.AttributeModifiers,FrameResource.EffectEvents,FrameResource.PlayerResources,FrameResource.PlayerSnapshotState,FrameResource.GameplayEvents},s.GraphCommitQueuedAbilities);
        ...
        private static void RegisterPreCombatGameplay(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveAction("ability.commit",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.AbilityRequests,FrameResource.PhaseState,FrameResource.EntityLifecycle,FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.EnemyHealth,FrameResource.EnemyControl,FrameResource.EnemyPosition,FrameResource.TowerState,FrameResource.ActiveEffects},new[]{FrameResource.AbilityRequests,FrameResource.AbilitiesCommitted,FrameResource.DamageRequests,FrameResource.ResourceRequests,FrameResource.ActiveEffects,FrameResource.AttributeModifiers,FrameResource.EffectEvents,FrameResource.PlayerResources,FrameResource.EnemyControl,FrameResource.EnemyPosition,FrameResource.EnemyMovement,FrameResource.TimeScaleState,FrameResource.EntityLifecycle,FrameResource.CorpseState,FrameResource.PlayerSnapshotState,FrameResource.GameplayEvents},s.GraphCommitQueuedAbilities);
        }

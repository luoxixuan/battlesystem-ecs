...
namespace BattleSystemECS.Core
{
    internal static class FrameSystemGraph
    {
        ...
        private static void RegisterBuild(Registrar r, FrameScheduler s)
        {
            ...
            r.AddBuild(g,"build.skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.PlayerSnapshotState,FrameResource.EntityLifecycle},new[]{FrameResource.PlayerResources,FrameResource.PlayerSnapshotState,FrameResource.AbilityRequests});
            r.AddBuild(g,"build.auto-skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.PlayerSnapshotState,FrameResource.EntityLifecycle},new[]{FrameResource.PlayerSnapshotState,FrameResource.AbilityRequests});
            ...
            r.AddBuild(g,"build.global-skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.TowerState},new[]{FrameResource.PlayerResources,FrameResource.TowerState,FrameResource.AbilityRequests});
            ...
            r.AddBuildAction("build.ability.commit",FrameTimeDomain.None,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.AbilityRequests,FrameResource.PhaseState,FrameResource.EntityLifecycle,FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.EnemyHealth,FrameResource.EnemyControl,FrameResource.TowerState,FrameResource.ActiveEffects,FrameResource.EffectRequests},new[]{FrameResource.AbilityRequests,FrameResource.AbilitiesCommitted,FrameResource.DamageRequests,FrameResource.ResourceRequests,FrameResource.EffectRequests,FrameResource.PlayerResources,FrameResource.PlayerSnapshotState,FrameResource.GameplayEvents},s.GraphCommitQueuedAbilities);
            ...
            r.AddBuildAction("build.ability.reject",FrameTimeDomain.None,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.AbilityRequests,FrameResource.EffectRequests},new[]{FrameResource.AbilityRequests,FrameResource.EffectRequests},s.GraphRejectNonWaveAbilities);
        ...
        private static void RegisterNonWave(Registrar r,FrameScheduler s)
        {
            ...
            r.AddOtherAction("non-wave.ability.reject",FrameExecutionSemantics.SerialCommit,new[]{FrameResource.AbilityRequests,FrameResource.EffectRequests},new[]{FrameResource.AbilityRequests,FrameResource.EffectRequests},s.GraphRejectNonWaveAbilities);
        ...
        private static void RegisterAI(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveBinding(s,"ai.enemy-ability.execute",FrameTimeDomain.None,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.EntityLifecycle,FrameResource.EnemyHealth,FrameResource.EnemyControl,FrameResource.EnemyPosition,FrameResource.EnemyMovement,FrameResource.TowerState,FrameResource.PlayerResources},new[]{FrameResource.AbilityRequests});
        ...
        private static void RegisterTerrain(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveBinding(s,"terrain.update",FrameTimeDomain.Enemy,FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.EntityLifecycle,FrameResource.EnemyPosition,FrameResource.TerrainState},new[]{FrameResource.EnemyMovement,FrameResource.EffectRequests});
        ...
        private static void RegisterPreCombatGameplay(Registrar r,FrameScheduler s)
        {
            r.AddWaveBinding(s,"skill-buff.skill.update",FrameTimeDomain.Combat,FrameExecutionSemantics.InternalParallelCollectSerialCommit,new[]{FrameResource.PlayerResources,FrameResource.EntityLifecycle,FrameResource.EnemyHealth,FrameResource.EnemyPosition,FrameResource.EnemyControl,FrameResource.EnemyMovement,FrameResource.TowerState,FrameResource.CorpseState,FrameResource.PlayerAttributes,FrameResource.PlayerSnapshotState,FrameResource.SkillPrepared},new[]{FrameResource.SkillDamageRequests,FrameResource.EnemyControl,FrameResource.EnemyPosition,FrameResource.EnemyMovement,FrameResource.PlayerResources,FrameResource.ResourceRequests,FrameResource.TimeScaleState,FrameResource.EntityLifecycle,FrameResource.CorpseState,FrameResource.PlayerSnapshotState,FrameResource.AbilityRequests,FrameResource.EffectRequests});
            r.AddWaveBinding(s,"combat.global-skill.update",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.PhaseState,FrameResource.EntityLifecycle,FrameResource.EnemyHealth,FrameResource.EnemyControl,FrameResource.TowerState,FrameResource.PlayerAttributes,FrameResource.PlayerResources},new[]{FrameResource.PlayerAttributes,FrameResource.TowerState,FrameResource.TimeScaleState,FrameResource.AbilityRequests});
            r.AddWaveBinding(s,"combat.tower-active-skill.update",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.PhaseState,FrameResource.EntityLifecycle,FrameResource.TowerState},new[]{FrameResource.TowerState,FrameResource.AbilityRequests});
            r.AddWaveBinding(s,"combat.hero-skill.update",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialUpdate,
                ...
                new[]{FrameResource.HeroState,FrameResource.AbilityRequests});
            r.AddWaveAction("ability.commit",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.AbilityRequests,FrameResource.PhaseState,FrameResource.EntityLifecycle,FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.EnemyHealth,FrameResource.EnemyControl,FrameResource.EnemyPosition,FrameResource.TowerState,FrameResource.ActiveEffects,FrameResource.EffectRequests},new[]{FrameResource.AbilityRequests,FrameResource.AbilitiesCommitted,FrameResource.DamageRequests,FrameResource.ResourceRequests,FrameResource.EffectRequests,FrameResource.PlayerResources,FrameResource.EnemyControl,FrameResource.EnemyPosition,FrameResource.EnemyMovement,FrameResource.TimeScaleState,FrameResource.EntityLifecycle,FrameResource.CorpseState,FrameResource.PlayerSnapshotState,FrameResource.GameplayEvents,FrameResource.TelegraphState},s.GraphCommitQueuedAbilities);
        }
        ...
        private static void RegisterCombat(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveBinding(s,"combat.demolish.update",FrameTimeDomain.None,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.EntityLifecycle,FrameResource.TowerState,FrameResource.EnemyPosition,FrameResource.EnemyHealth,FrameResource.SpatialIndex},new[]{FrameResource.EntityLifecycle,FrameResource.TowerState,FrameResource.EnemyControl,FrameResource.DamageRequests,FrameResource.DeathQueue,FrameResource.EffectRequests});
        ...
        private static void RegisterSkillBuff(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveAction("effect.commit",FrameTimeDomain.None,FrameExecutionSemantics.SerialCommit,new[]{FrameResource.EffectRequests,FrameResource.EntityLifecycle},new[]{FrameResource.EffectRequests,FrameResource.ActiveEffects,FrameResource.AttributeModifiers,FrameResource.EffectEvents},s.GraphCommitQueuedEffects);
            ...
            r.AddWaveBinding(s,"skill-buff.rally.update",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.ResourceEvents,FrameResource.PlayerAttributes,FrameResource.TowerState},new[]{FrameResource.PlayerAttributes,FrameResource.TowerState});
        }

...
namespace BattleSystemECS.Core
{
    internal static class FrameSystemGraph
    {
        ...
        private static void RegisterBuild(Registrar r, FrameScheduler s)
        {
            ...
            r.AddBuild(g,"build.skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.AbilityRequests,FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.PlayerSnapshotState,FrameResource.EntityLifecycle},new[]{FrameResource.AbilityRequests,FrameResource.PlayerResources,FrameResource.ResourceRequests,FrameResource.PlayerSnapshotState});
            r.AddBuild(g,"build.auto-skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.AbilityRequests,FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.PlayerSnapshotState,FrameResource.EntityLifecycle},new[]{FrameResource.AbilityRequests,FrameResource.ResourceRequests,FrameResource.PlayerSnapshotState});
            ...
            r.AddBuild(g,"build.global-skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.AbilityRequests,FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.TowerState},new[]{FrameResource.AbilityRequests,FrameResource.PlayerResources,FrameResource.TowerState,FrameResource.ResourceRequests});
        ...
        private static void RegisterCombat(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveBinding(s,"combat.player-attack.update",FrameTimeDomain.None,FrameExecutionSemantics.InternalParallelCollectSerialCommit,new[]{FrameResource.EntityLifecycle,FrameResource.EnemyHealth,FrameResource.EnemyControl,FrameResource.EnemyPosition,FrameResource.PlayerAttributes,FrameResource.ComputedAttributes,FrameResource.PlayerAttackPrepared},new[]{FrameResource.EnemyControl,FrameResource.PlayerAttributes,FrameResource.DamageRequests,FrameResource.DeathQueue,FrameResource.GameplayEvents,FrameResource.PresentationEvents});

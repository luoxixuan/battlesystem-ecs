...
namespace BattleSystemECS.Core
{
    internal static class FrameSystemGraph
    {
        ...
        private static void RegisterBuild(Registrar r, FrameScheduler s)
        {
            ...
            r.AddBuild(g,"build.skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.PlayerSnapshotState,FrameResource.EntityLifecycle},new[]{FrameResource.PlayerResources,FrameResource.ResourceRequests,FrameResource.PlayerSnapshotState,FrameResource.AbilityRequests});
            r.AddBuild(g,"build.auto-skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.PlayerSnapshotState,FrameResource.EntityLifecycle},new[]{FrameResource.ResourceRequests,FrameResource.PlayerSnapshotState,FrameResource.AbilityRequests});
            ...
            r.AddBuild(g,"build.global-skill.update",FrameExecutionSemantics.SerialUpdate,new[]{FrameResource.PlayerResources,FrameResource.PlayerAttributes,FrameResource.TowerState},new[]{FrameResource.PlayerResources,FrameResource.TowerState,FrameResource.ResourceRequests,FrameResource.AbilityRequests});
        ...
        private static void RegisterCombat(Registrar r,FrameScheduler s)
        {
            ...
            r.AddWaveBinding(s,"combat.hero-skill.update",FrameTimeDomain.Combat,FrameExecutionSemantics.SerialUpdate,
                ...
                new[]{FrameResource.HeroState,FrameResource.DamageRequests,FrameResource.ResourceRequests,FrameResource.GameplayEvents,FrameResource.AbilityRequests});

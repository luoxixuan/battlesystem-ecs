...
namespace BattleSystemECS.Core.GAS
{
    public static class CatalogRegistries
    {
        ...
        { ["AttackDamage"] = new AttributeKey(0), ["AttackRange"] = new AttributeKey(1), ["MaxHealth"] = new AttributeKey(2), ["CurrentHealth"] = new AttributeKey(3), ["Gold"] = new AttributeKey(4), ["CritRate"] = new AttributeKey(5), ["BuffStrength"] = new AttributeKey(6), ["Mana"] = new AttributeKey(7) };

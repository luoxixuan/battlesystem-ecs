...
namespace BattleSystemECS.Core.GAS
{
    ...
    /// <summary>V1 只实现 Replace：新快照整张替换当前条目的 modifier 捕获。KeepPerLayer 不进 V1。</summary>
    public enum StackSnapshotPolicy { Replace = 0 }
    ...
    public readonly struct GameplayEffectDefinition
    {
        ...
        public readonly StackSnapshotPolicy StackSnapshot;
    ...
    public struct ActiveGameplayEffect
    {
        ...
        /// <summary>条目的 modifier 捕获（与 DoT 跳伤 CapturedMagnitude 分列）。V1 Replace 时整张替换。</summary>
        public float CapturedModifierMagnitude;

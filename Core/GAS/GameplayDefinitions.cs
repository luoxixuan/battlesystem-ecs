...
namespace BattleSystemECS.Core.GAS
{
    ...
    public enum EffectPayloadKind { Damage, Heal, Shield, Resurrect, Resource, CrowdControl, Slow, GameplayEvent, WorldAction, Status, Dispel }
    public enum ExecutionOperation { Default, ApplyDamage, ApplyHeal, ApplyShield, Resurrect, RestoreSnapshot, ApplyCrowdControl, ApplySlow, SummonEnemy, PrepareStealth, ApplyEnemyBuff, ApplyTowerSilence, RemoveDispellableEffects }
